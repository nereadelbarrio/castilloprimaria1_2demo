...
$(document).ready(function () {
	...
	var src_logo = $('.content_type_clase_castillopreescolar2022demo').find('.logo_slide').attr('logo_dominio');
	if (typeof(src_logo) != 'undefined' && src_logo && src_logo != '' && src_logo.indexOf('gif1x1.gif') == -1) {
		$('.content_type_clase_castillopreescolar2022demo').find('.logo-publisher').css('background-image', "url('"+src_logo+"')");
	}
});
